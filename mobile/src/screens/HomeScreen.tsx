          ...
          <View style={{
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ gap: 10, paddingBottom: 20 }}>
              {[
                ...
                { num: '+1 (555) 678-3260', title: 'WhatsApp AI Sathi', desc: 'Instant live train tracking, catch probability & support', icon: <MessageCircle size={18} color="#25D366" />, isWhatsApp: true, action: 'whatsapp://send?phone=15556783260&text=Hi' },
